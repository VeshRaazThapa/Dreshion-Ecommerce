...
def recognize_face(saved_image_path):
    # Load an image with an unknown face
    unknown_image = face_recognition.load_image_file(saved_image_path)
...
def exact_color(input_image, resize, tolerance, zoom):
    ...
    # resize
    output_width = resize
    img = recognize_face(input_image)
    ...
    image = recognize_face(resize_name)
